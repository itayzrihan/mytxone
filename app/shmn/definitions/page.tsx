...
import { DefinitionManager } from '@/components/custom/shmn/definition-manager';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/80 text-text-primary">
      <div className="container mx-auto px-4 py-16">
        ...
        <div id="definition-modal" className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center hidden">
          <div className="bg-card-background rounded-lg shadow-xl border border-primary/10 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-5 border-b border-white/10 flex justify-between items-center">
              <h3 className="text-xl font-medium text-primary">Create New Definition</h3>
            ...
            <div className="p-5">
              <div className="mb-5">
                <label htmlFor="definition-name" className="block text-text-primary mb-2">Term Name</label>
                <input 
                  type="text" 
                  id="definition-name" 
              ...
              <div className="mb-5">
                <label htmlFor="definition-description" className="block text-text-primary mb-2">Description (Optional)</label>
                <textarea 
                  ...
                  placeholder="Enter a brief description of this term"
                ></textarea>
              </div>
              
              <div className="mb-5">
                <label htmlFor="definition-content" className="block text-text-primary mb-2">Definition Content</label>
                <textarea 
                  id="definition-content" 
                  className="w-full p-3 bg-black/20 border border-white/10 rounded-md text-text-primary focus:border-primary focus:outline-none min-h-[200px]"
                  placeholder="Enter your detailed definition of this term"
                ></textarea>
              </div>
            </div>
        ...
        <div id="view-definition-modal" className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center hidden">
          <div className="bg-card-background rounded-lg shadow-xl border border-primary/10 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-5 border-b border-white/10 flex justify-between items-center">
              ...
              <button id="close-view-modal" className="text-text-secondary hover:text-text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="18" y1="6" x2="6" y2="18"></line>
                  <line x1="6" y1="6" x2="18" y2="18"></line>
                </svg>
