...
// --- Types ---
export interface MytxChatRequest {
  messages: Message[];
  uid: string;
}

export interface MytxChatValidationResult {
  success: boolean;
  data?: Message[];
  error?: string;
  details?: any;
...
// --- Validation Function ---
export function validateMytxChatRequest(body: any): MytxChatValidationResult {
...
// --- Core Mytx Chat Service ---
export async function processMytxChatRequest({ messages, uid }: MytxChatRequest) {
  // 1. Prepare Messages for AI SDK
  ...
  // 2. Call AI Model with Full Tools Support
